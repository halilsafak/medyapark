...
function renderMec(){
  ...
  const specAcc=`<details class="acc" open><summary>Teknik Özellikler</summary><div>${specRows||'<p class="muted">—</p>'}</div></details>`;
  ...
  app().innerHTML=`
    ...
    <div style="margin-top:14px">${specAcc}</div>
    <div class="book" style="margin-top:18px">
      ...
      <p class="muted" style="font-size:13px;margin:0 0 12px">Müsait bir aya tıklayarak teklif sepetine ekleyin; ekibimiz size özel teklif hazırlasın.</p>
